...
- Current tagged release for GAMIT (native): [https://github.com/miketrcs/RCSGAMDevelopment/releases/tag/v1.5.7](https://github.com/miketrcs/RCSGAMDevelopment/releases/tag/v1.5.7)
...
- Current native GUI version: `1.5.7`
...
- `GAMIT` (`GAMMultiGUI-Native`): `1.5.7`
...
- `GAMMultiGUI-Native/dist/GAMIT-1.5.7.pkg`: native macOS installer package
- `GAMMultiGUI-Native/dist/GAMIT-1.5.7.pkg.sha256`: SHA-256 checksum for the native installer package
...
shasum -a 256 -c GAMMultiGUI-Native/dist/GAMIT-1.5.7.pkg.sha256
