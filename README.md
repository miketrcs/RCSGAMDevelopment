...
- Use at your own risk. Review and validate the code before use. See [DISCLAIMER.md](DISCLAIMER.md).
...
- `GAMMultiGUI/`: Original macOS SwiftUI wrapper for running the parallel script with a local GUI.
- `GAMMultiGUI-Native/`: `GAMIT`, the separate native macOS SwiftUI app that calls `gam` directly without the Python runner scripts.
...
- Current tagged release for GAMIT (native): [https://github.com/miketrcs/RCSGAMDevelopment/releases/tag/v1.5.10](https://github.com/miketrcs/RCSGAMDevelopment/releases/tag/v1.5.10)
...
- Current native GUI version: `1.5.10`
...
- `GAMIT` (`GAMMultiGUI-Native`): `1.5.10`
...
- `GAMMultiGUI-Native/dist/GAMIT-1.5.10.pkg`: native macOS installer package
- `GAMMultiGUI-Native/dist/GAMIT-1.5.10.pkg.sha256`: SHA-256 checksum for the native installer package
...
- installs `GAMIT.app` into `/Applications`
...
shasum -a 256 -c GAMMultiGUI-Native/dist/GAMIT-1.5.10.pkg.sha256
